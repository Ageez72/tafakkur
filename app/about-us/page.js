                        ...
                        <div className="row vision-wrapper">
                            <div className="col-12 col-md-6">
                                <div className="vision-card">
                                    ...
                                    <p>أن نكون المؤسسة العلمية الرائدة التي تقدم رؤية منهجية علمية تطبيقية متكاملة للمؤسسات التعليمية والأسر لتنجح في تربية أبنائها ليكونوا مبدعين وأخلاقيين، قادرين على القيام بدورهم المستقبلي في نهضة أوطانهم.</p>
                                </div>
                            </div>
                            <div className="col-12 col-md-6 mt-4 mt-md-0">
                                <div className="vision-card">
                                    <h3 className="mb-4 head-blue">رسالتنا</h3>
                                    <p>نساهم في تطوير الواقع التربوي من خلال تقديم البحوث والبرامج التطبيقية والتدريبية المبتكرة لتربية الشخصية الإبداعية الأخلاقية.</p>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="container custom-container">
                                    ...
                                    <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                        <div className="accordion-body">
                                            ...
                                            <p>
                                                يجري فريق البحث العلمي البحوث والدراسات النظرية والتجريبية المتخصصة في مجال بناء الشخصية المتكاملة، وتعليم التفكر وتنمية الإبداع والذكاء، وبناء تقدير الذات، وتطوير السلوك الأخلاقي، بإشراك عشرات المؤسسات العلمية في مختلف الدول، وبالتعاون مع الكوادر التعليمية التي تتعامل مباشرة مع الطفل داخل المؤسسة التعليمية، حيث تبدأ عينات الدراسة من <span className="en-txt">50</span> طالب وطالبة وتصل إلى <span className="en-txt">8500</span> طالب وطالبة في بعض الدراسات.
                                            </p>
                                        </div>
                                    </div>
                                </div>
