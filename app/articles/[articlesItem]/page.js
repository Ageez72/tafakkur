...
export default function newsPage({ params }) {
    ...
    const fetchData = async () => {
        ...
        try {
            const res = await fetch(`${state.HTTP_URL}articles/${params.articlesItem}`, requestOptions);
            if (!res.ok) {
                    ...
                    <div className="container">
                        <div className="news-details-wrapper">
                            <div className="row">
                                ...
                                <div className="col-lg-3 ps-5 news-sectors articles-sectors d-none d-lg-block">
