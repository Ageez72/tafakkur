                            ...
                            <div className="row align-items-center h-100">
                                <div className="col-12 col-md-6 section-padding ps-3 pe-5">
                                    ...
                                    <div className="trainee-info">
                                        ...
                                        <VideoPopup videoTitleIcon="fa-arrow-left-long" title={" شاهد جانب من البرنامج التدريبي"} style={2} videoId={courseData?.course.url && getYouTubeVideoID(courseData?.course.url)} />
                                    </div>
                                </div>
                            ...
                            <div className="row h-100">
                                <div className="col-12 col-md-6 video-wrapper">
                                    ...
                                    <div className="video-wrapper">
                                        ...
                                        <img className="w-100 object-fit border-radius-8" src={courseData?.course?.opinion_video_image} alt="course" />
                                    </div>
                                </div>
