                        ...
                        <div className="container h-100">
                            ...
                            <div className="row g-4 align-items-center h-100">
                                <div className="col-lg-6 mb-4">
                                    <div className="about-tafakuur-content px-0 pe-lg-5 ps-lg-4">
                                        ...
                                        <div className="action-buttons d-flex align-items-center flex-wrap">
                                            ...
                                            <Link className="hover-btn d-inline-block py-1 mt-3" href="https://forms.zohopublic.com/tafakkur/form/Untitled19/formperma/ZwPaVDv5Ld5kLqH7iN28BBABGeQ4CqON5AF5LrFYrY4">
                                                طبق في مؤسستك
                                            </Link>
                                        </div>
                                    </div>
                                ...
                                <div className="col-lg-6 mt-0 slider-side pe-0">
                                    ...
                                    <Image className='w-100 h-100 object-fit' src="https://d329sg0poh8k4h.cloudfront.net/tafakkur-website/anos/1733144852-طالب-مبتسم-في-مدرسة-مطبقة-لمنهاج-تفكر-مع-أنوس-المقدم-من-مؤسسة-تفكر-لبناء-الإنسان.png" alt='image' />
